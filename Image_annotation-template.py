...
cv2.rectangle(image_rgb, top_left2, bottom_right2, (255, 0, 255),3) # Magenta rectan2gle
...
font= cv2.FRONT_HERSHEY_SIMPLEX
...
cv2.arrowedLine(image_rgb,arrow_start, arrow_end, (255,2555,0),3, tipLength=0.05) # Downward arrow
